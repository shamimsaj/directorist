<?php
/**
 * All locations element class.
 * 
 * @author wpWax
 */
namespace wpWax\Directorist\Oxygen;

class AllLocations extends Element {

	protected $shouldProcessParams = true;

	public function name() {
		return esc_html__( 'All Locations', 'directorist' );
	}

	public function slug() {
		return 'directorist-all-locations';
	}
